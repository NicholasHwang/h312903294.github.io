...
##后向传递(backward pass)
按照我对[cs231n](http://cs231n.github.io/optimization-2/)的理解，后向传递其实就是对网络进行逆序的求导过程。
